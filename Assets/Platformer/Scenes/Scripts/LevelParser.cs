...
public class LevelParser : MonoBehaviour
{
    ...
    void LoadLevel()
    {
        ...
        // Use this variable in the to do code!!
        int row = 0;
        ...
        while (levelRows.Count > 0)
        {
            ...
            {
                // To do - Instantiate a new GameObject that matches the type specified by letter
                ...
                if (letters[col] == 'p')
                {
                    GameObject newObj = Instantiate(pipePrefab, environmentRoot);
                    newObj.transform.position = pos;
                }
                if (letters[col] == 'g')
                {
